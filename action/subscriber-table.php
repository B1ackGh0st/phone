...
if (isset($_POST['id'])) {
  ...
  $subdivisionSql = "SELECT id, name, position FROM subscriber WHERE subdivision_id='".$id."' ORDER BY position ASC";
  ...
  while($subdivision = pg_fetch_array($subdivisionQuery)) {
    echo '      <tr id=row-'.$subdivision['id'].'>
                  ...
                  <td>
                    <img src="img/chevron-top-2x.png" id="'.$subdivision['id'].'" class="subscriber-position-up">
                    <img src="img/chevron-bottom-2x.png" id="'.$subdivision['id'].'" class="subscriber-position-down">
                    <img type="button" src="img/pencil-2x.png" data-toggle="modal" data-target="#exampleModalLong">
                    <img src="img/trash-2x.png" id="'.$subdivision['id'].'" class="subscriber-del">
                  </td>
                </tr>';
  }
  echo "      </tbody>
